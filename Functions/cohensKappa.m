function [FN, FP, P, R, kappa, OE, label_map] = cohensKappa(y, yhat, verbose)
...
% verbose       - 1 To show the label_map error
...
%%  
    ...
    FN = (C(2,1)/total_cd_pixels)*100;
    FP = (C(1,2)/total_ncd_pixels)*100;
